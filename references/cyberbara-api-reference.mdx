...
| `options.audio_input`  | `string[]`           | No       | URL array                                  | Audio references sent to KIE as `audio_urls` |
...
Kling 3.0 Omni pricing is calculated per output second: 720p is 14 credits without
audio or video input, 18 with audio input, and 20 with video input; 1080p is
