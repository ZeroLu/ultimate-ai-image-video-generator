...
- Billing uses 480p / 720p / 1080p per-second rates and supports up to 30 seconds.
...
| `options.resolution`           | `string`             | No                            | `480p` / `720p` / `1080p` (default `720p`)                        | Supported in text-to-video, image-to-video, and video-to-video |
...
Fields are the same as `seedance-2.5`, including `480p`, `720p`, and `1080p` output. The stable route uses enterprise-grade routing and different credit rates.
